...
def get_network(args, num_cls=50, use_gpu=True):
...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    trainDataset = CustomImageDataset('/Dataset/Training', transform=transform_train)
    training_loader = CustomImageDataset(
        trainDataset, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size)
...
def get_test_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    testDataset = CustomImageDataset('Dataset/Validation', transform=transform_test)
    test_loader = DataLoader(
        testDataset, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size)
